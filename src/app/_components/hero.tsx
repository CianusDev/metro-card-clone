  ...
  return (
    <section className='grid grid-cols-1 px-4 md:grid-cols-1 gap-8 w-full'>
        <div className='flex flex-col justify-center items-center gap-8 flex-shrink-0 space-y-4 w-full'>
            <h1 className='font-bold text-7xl text-center'>US Bank Accounts For Remote Workers</h1>
            <p className='text-muted-foreground text-center text-xl'>Easily set up bank accounts in USD, GBP, and EUR to effortlessly accept payments from around the world. Plus, enjoy the convenience of a USD virtual debit card for your global expenses.</p>
            ...
            <div className='grid  grid-cols-2 md:grid-cols-2 gap-4 max-w-md w-full'>
                ...
                <Image src={"/assets/app_store.png"} alt="google play" className='cursor-pointer border-2 rounded-xl w-full h-16 md:h-20' width={170} height={40}/>
                <Image src={"/assets/play-store.png"} alt="google play" className='cursor-pointer border-2 rounded-xl w-full h-16 md:h-20' width={200} height={40}/>
